    ...
    public class Given_I_Update_A_Report
    {
        ...
        public void When_Report_Is_Updated_Less_Than_Audit_Window_Size_Ago_Then_Audit_Record_Is_Not_Created()
        {
            ...
            var updateReportRequest = new UpdateReportRequest
            {
                ...
                AuditWindowSize = TimeSpan.FromMinutes(5)
            };
        ...
        [Test]
        public void When_Report_Not_Supplied_Then_Throw_Error()
        {
            // arrange
            var updateReportRequest = new UpdateReportRequest { Report = null, UserName = "Bob Shurunkle"};
        ...
        public void When_Old_Version_Cannot_Be_Found_Then_Throw_Error()
        {
            // arrange
            var reportId = Guid.NewGuid();
            var updateReportRequest = new UpdateReportRequest { Report = new Report {Id = reportId}, UserName = "Bob Shurunkle"};
