...
namespace SFA.DAS.PSRService.Web.UnitTests.ReportControllerTests
{
    ...
    public class Given_A_ReportController
    {
        ...
        public Given_A_ReportController()
        {
            ...
            _controller = new ReportController(_mockReportService.Object, _employeeAccountServiceMock.Object,
                _userServiceMock.Object, null, _periodServiceMock.Object) {Url = _mockUrlHelper.Object};
