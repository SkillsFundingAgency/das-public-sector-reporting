...
namespace SFA.DAS.PSRService.Web.UnitTests.ServiceTests.PeriodServiceTests.Given_A_PeriodService
{
    ...
    public sealed class When_ReportIsForCurrentPeriod_Is_Called_With_Earlier_Period_Report
        :Given_A_PeriodService
    {
        private bool reportIsForCurrentPeriod;

        public When_ReportIsForCurrentPeriod_Is_Called_With_Earlier_Period_Report(int year, int month, int day) : base(year, month, day)
        {
            var report
                =
                new ReportBuilder()
            ...
            report.Period = Period.FromInstantInPeriod(CurrentInstant.AddYears(-2));
        ...
        public void Then_False_Is_Returned()
        {
            reportIsForCurrentPeriod
                .Should()
                .BeFalse("Report is for an earlier period");
        }
    }
}