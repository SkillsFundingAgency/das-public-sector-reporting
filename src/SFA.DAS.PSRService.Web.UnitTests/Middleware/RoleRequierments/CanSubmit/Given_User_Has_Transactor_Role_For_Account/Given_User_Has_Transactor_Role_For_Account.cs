...
public abstract class Given_User_Has_Transactor_Role_For_Account : GivenWhenThen<CanSubmitReportHandler>
{
    ...
    private ClaimsPrincipal BuildUserWithRequiredRoleForAccount()
    {
        ...
        [
            new Claim(EmployerPsrsClaims.AccountsClaimsTypeIdentifier, EmployerIdentifierWithOwnerRoleForAccount()
    ...
    private static string EmployerIdentifierWithOwnerRoleForAccount()
    {
        return JsonConvert.SerializeObject(new Dictionary<string, EmployerIdentifier>
        {
            ...
            {
                AccountId = AccountId,
                Role = EmployerPsrsRoleNames.Transactor
            }
        });
    }
}