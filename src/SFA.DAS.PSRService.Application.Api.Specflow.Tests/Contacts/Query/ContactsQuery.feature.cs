...
namespace SFA.DAS.PSRService.Application.Api.Specflow.Tests.Contacts.Query
{
    ...
    [NUnit.Framework.DescriptionAttribute("Query Contacts through the SFA.DAS.PSRService.Application.Api")]
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Query Contacts through the SFA.DAS.PSRService.Application.Api", "\tIn order to be able to get information on Contacts\r\n\tAs a System\r\n\tI want to be " +
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Search Report for an Organisation By Username")]
        public virtual void SearchContactForAnOrganisationByUsername()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Search Report for an Organisation By Username", ((string[])(null)));
#line 18
this.ScenarioSetup(scenarioInfo);
#line 19
 testRunner.Given("System Has access to the SFA.DAS.AssessmentOrgs.Api", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
...
#line 23
 testRunner.Then("the response http status should be OK", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 24
 testRunner.And("the API returns a valid Report", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            this.ScenarioCleanup();
        }
    }
