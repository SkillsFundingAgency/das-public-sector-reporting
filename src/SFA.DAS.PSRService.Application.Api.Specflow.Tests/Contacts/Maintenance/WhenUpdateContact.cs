//namespace SFA.DAS.PSRService.Application.Api.Specflow.Tests.Contacts.Maintenance
//{
...
//        [When(@"I Update a Report succesfully")]
...
//        [Then(@"the Report Update should have occured")]
//        public void ThenTheContactUpdateShouldHaveOccured()
//        {
//            var contactEntities = _dbconnection.Query<Contact>
//             ($"Select Id, UserName, DisplayName, EMail, ReportStatus From Contacts where UserName = '{_contactQueryViewModel.Username}'").ToList();
...
//            contact.ContactStatus.Should().Be(ReportStatus.Live);
//        }
