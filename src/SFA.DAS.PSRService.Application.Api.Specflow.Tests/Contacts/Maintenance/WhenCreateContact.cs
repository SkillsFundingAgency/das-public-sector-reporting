//namespace SFA.DAS.PSRService.Application.Api.Specflow.Tests.Organisations
//{
...
//        [When(@"I Create a Report as First User for Organisation")]
...
//        [When(@"I Create a Report as another User for Organisation")]
...
//        [Then(@"the Report Status should be set to Live")]
//        public void ThenTheContactStatusShouldBeSetToLive()
//        {
//            _contactQueryViewModel.ContactStatus.Should().Be(ReportStatus.Live);
//        }

//        [Then(@"the Report Organisation Status should be set to (.*)")]
...
//        [When(@"I Create a Report That already exists")]
